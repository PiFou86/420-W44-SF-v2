...
- Les trois options suivantes se trouveront dans votre `Node Pool` par défaut : 
  - Taille de noeud : choisissez `Série Av2` et prenez la plus petite taille disponible dans votre région (la moins chère) !! N'oubliez pas de supprimer vos ressources lorsque vous avez fini pour éviter des coûts !!
