...
- Pour exécuter le déploiement, utilisez la commande `az group deployment create --resource-group M04-Ex04-T03 --template-file template.json --parameters parameters.json`
