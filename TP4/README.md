...
- Remise du travail: dimanche 15 mars 2026, 23:59
- Ce travail est réalisé en équipe de 2 (ou 3 max avec l'approbation du professeur) personnes et seuls les membres de cette équipe y contribuent
...
Le projet est écrit en .Net 8.0. Vous devriez trouver une version fonctionnel ici : [Projet de départ](https://github.com/rparadiscsfoy/srcTP3-4ProjetITV) Une ancienne version en .Net 6.0 se trouve dans le répertoire src du TP précédent.
